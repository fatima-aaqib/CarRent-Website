                  ...
                  <div className="lg:w-3/4 p-6">
                      <div className="flex justify-center flex-col md:flex-row w-1/1 lg:flex-row space-y-6 lg:space-y-0 lg:space-x-6">
                          ...
                          <div className=" flex-col md:flex-row w-1/1 lg:bg-white p-8 rounded-lg shadow">
                              <div className=" flex-col md:flex-row w-1/1  lg:w-[500px] p-6 rounded-lg text-white">
                                  
                                  <Image src="/View.png" alt=""  width={200} height={100} className="mt-4 md:w-1/1 w-full rounded-lg" />
                      ...
                      <div className="mt-6 bg-white p-6 rounded-lg shadow">
                          ...
                          <div className="mt-4">
                              <div className="flex items-start space-x-4">
                                  ...
                                  alt="Profile picture of Alex Stanton" className="w-12 h-12 rounded-full" />
                                  <div>
