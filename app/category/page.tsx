  ...
  <div className="container mx-auto p-4">
   <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     className="w-[272px] h-[84px] object-cover my-4" src="/car%20(10).jpg"/>
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     <Image alt="Silver Nissan GT - R car" className="w-[272px] h-[84px] object-cover my-4" height={200} src="/car%20(1).jpg" width={300}/>
     <div className="flex justify-between items-center text-gray-500">
      <div className="flex items-center space-x-2">
       <i className="fas fa-gas-pump">
       </i>
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     <Image alt="Blue Rolls-Royce car" className="w-[272px] h[84px] object-cover my-4" width={500} height={200} src="/Car%20(2).jpg" />
     <div className="flex justify-between items-center text-gray-500">
      <div className="flex items-center space-x-2">
       <i className="fas fa-gas-pump">
       </i>
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     <Image alt="Gray All New Rush car" className="w-[272px] h-[84px] object-cover my-4" height={200} src="/Car%20(3).jpg" width={300}/>
     <div className="flex justify-between items-center text-gray-500">
      <div className="flex items-center space-x-2">
       <i className="fas fa-gas-pump">
       </i>
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     <Image alt="Brown CR - V car" className="w-[272px] h-[84px] object-cover my-4" height={200} src="/Car%20(4).jpg" width={300}/>
     <div className="flex justify-between items-center text-gray-500">
      <div className="flex items-center space-x-2">
       <i className="fas fa-gas-pump">
       </i>
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     <Image alt="Blue All New Terios car" className="w-[272px] h-[84px] object-cover my-4" height={200} src="/Car%20(5).jpg" width={300}/>
     <div className="flex justify-between items-center text-gray-500">
      <div className="flex items-center space-x-2">
       <i className="fas fa-gas-pump">
       </i>
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     <Image alt="Blue MG ZX Exclucise car" className="w-[272px] h-[84px] object-cover my-4" height={200} src="/Car%20(7).jpg" width={300}/>
     <div className="flex justify-between items-center text-gray-500">
      <div className="flex items-center space-x-2">
       <i className="fas fa-gas-pump">
       </i>
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     <Image alt="White New MGZS car" className="w-[272px] h-[84px] object-cover my-4" height={200} src="/Car%20(8).jpg" width={300}/>
     <div className="flex justify-between items-center text-gray-500">
      <div className="flex items-center space-x-2">
       <i className="fas fa-gas-pump">
       </i>
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
     ...
     <Image alt="Blue MG ZX Excite car" className="w-[272px] h-[84px] object-cover my-4" height={200} src="/Car%20(7).jpg" width={300}/>
     <div className="flex justify-between items-center text-gray-500">
      <div className="flex items-center space-x-2">
       <i className="fas fa-gas-pump">
       </i>
